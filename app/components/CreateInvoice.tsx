...
export function CreateInvoice({address, lastName, firstName,email}: iAppProps) {
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-6">
                    <div>
                        ...
                        <div className="flex">
                            ...
                            className="rounded-r-none" placeholder="5" />
                        </div>
        ...
        />
                ...
                <div className="grid grid-cols-12 gap-4 mb-4">
                    <div className="col-span-6">
                        ...
                        placeholder="Item or service name & description  "/>
                ...
                <div className="flex justify-end">
                    <div className="w-1/3">
                        ...
                        <div className="flex justify-between py-2 border-t">
                            ...
                            <span className="font-medium underline nderline-offset-2">{formatCurrency({amount: calcualteTotal , currency: currency as any,})}</span>
                        </div>
                    </div>
                </div>
